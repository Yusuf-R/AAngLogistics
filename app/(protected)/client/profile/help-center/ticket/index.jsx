...
import Tickets from "../../../../../../components/Client/Profile/HelpCenter/Tickets";
...
function TicketScreen() {
    ...
    const { data: allTicketsData, isLoading: statsLoading } = useQuery({
        queryKey: ['Tickets'],
        queryFn: () => ClientUtils.getSupportTickets(null), // Get all tickets
        staleTime: Infinity,
        cacheTime: Infinity,
    ...
    const { data, isLoading, isError, error, refetch, isRefetching } = useQuery({
        ...
        queryFn: () => ClientUtils.getSupportTickets(
