...
export default function Profile({userData = null}) {
    ...
    const updateProfileMutation = useMutation({
        ...
        mutationFn: DriverUtils.UpdateProfile,
    });
    ...
    const handleImageUpload = async (userData) => {
        ...
        try {
            const {timestamp, signature, public_id, api_key} = await DriverUtils.GetSignedUrl();
            ;
        ...
        try {
            ...
            updateProfileMutation.mutate(submitData, {
                onSuccess: async (respData) => {
                    ...
                    setTimeout(() => {
                        setModalVisible(false);
                        router.replace({pathname: '/driver/account'});
                    }, 3500);
                },
                onError: (error) => {
                    setModalStatus('error');
                    toast.success('Error: Profile updat failed')
