...
import {driverFaqData} from '../../../../utils/Driver/Constants.js';
...
function DriverFaq() {
    ...
    const categories = Object.keys(driverFaqData);
    const router = useRouter();

    const filteredQuestions = useMemo(() => {
        if (!searchQuery.trim()) {
            return driverFaqData[activeCategory]?.questions || [];
        }

        const allQuestions = [];
        Object.entries(driverFaqData).forEach(([category, data]) => {
    ...
    const currentCategoryData = driverFaqData[activeCategory];
    ...
    const handleCreateTicket = () => {
        handleCloseModal();
        router.push('/driver/account/support/ticket/create');
    };
            ...
            >
                ...
                >
                    {categories.map((category) => {
                        const categoryData = driverFaqData[category];
